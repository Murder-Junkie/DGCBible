...
- **New Life Rule:**  
  Triggered once you are incapacitated and respawn at the hospital; the cause of death is irrelevant. Getting yourself downed is not considered as dying; therefore, once you get treated by EMS, the new life rule is not triggered. You lose all memory from the scenario if you respawn by using "E".
...
- **Another player is not able to decide when another permanently kills their character; this is decided upon OOC** and once agreed, they can commence with the scenario. You are allowed to plan out a scenario OOC if you decide on permaing (killing your character).
